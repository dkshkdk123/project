...
<style>
        ...
        .join_normal{color: #171717; font-size: 12px; line-height: 70px;}
        ...
        #text1{border: 1px solid#ddd; width: 100%; height: 300px
        ; margin-top: 30px;}
        .text_person, .text_person2{clear: both; width: 1280px; height: 20px; margin: 0 auto;}
        .person, .person2{float: left; padding-top: 30px;}
        .person li p, .person li p{font-size: 13px; color: #454545; line-height: 20px;}
        .text_check, .text_check2{float: right; padding-top: 30px;}
        .text_chk, .text_chk2{font-size: 11px; color: #5E5E5E; ;}
        #text2{border: 1px solid#ddd; width: 100%; height: 300px
        ; margin-top: 30px; margin-bottom: 30px;}
        .join_bottom{clear: both; width: 450px; margin: 0 auto;}
        .join_bottom li{text-align: center; display: inline-block; 
        margin-right: 20px;  width: 200px;height: 50px;
        border-radius: 30px;  line-height: 50px;
        margin-bottom: 50px; }
        .join_bottom li a{color: #fff; }
        .join_btn{color: #00529c; font-size: 12px; background-color: #00529c;}
        .join_index{color: #9E9E9E; font-size: 12px; background-color: #5E5E5E;}
</style>
</head>
<body>
	<%@ include file ="nav.jsp"%>
        ...
        <section class="login">
            <h1 class="login_h1">회원가입</h1>
            <ul class="login_top">
                <li class="login_btn"><a href="./login.html">로그인</a></li>
                <li class="login_btn2"><a href="./join.html">회원가입</a></li>
        ...
        <section class="join">
            ...
            <ul class="join_ul">
                <li>
                    <span class="join_co">STEP 1. </span>
                    <span class="join_normal">약관동의
                        <a href="" class="join_img"><img src="./img/join_ic1_on.png" alt=""></a>
                    </span>
                </li>
                <li>
                    <span class="join_none"></span>
                    <span class="join_normal">STEP 2. 정보입력
                        <a href="" class="join_img2"><img src="./img/join_ic2.png" alt=""></a>
                    </span>
                </li>
                <li>
                    <span class="join_none"></span>
                    <span class="join_none">STEP 3. 가입완료
                        <a href="" class="join_img3"><img src="./img/join_ic3.png" alt=""></a>
                    </span>
                </li>
            </ul>
            <div class="text_person2">
                <div class="person2">
                    <li>
                        <p>개인정보처리방침</p>
                    </li>
                </div>
                <div class="text_check2">
                    <input type="checkbox" id="" name="" class="texc_chk2">개인정보취급방침의 내용에 동의합니다.</input>
                </div>
            </div>   
            <textarea name="" id="text2" cols="1000" rows="100" readonly>
                제1조(목적)
“이 약관은 주식회사 글루온아이앤에스가 운영하는 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리의무 및 책임사항을 규정함을 목적으로 합니다.”

※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
①“몰” 이란 주식회사 글루온아이앤에스 회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호?모사전송번호?전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 주식회사 에스에스엘케이에이치 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
③ "몰”은 회원이 작성, 등록한 게시물을 무상으로 검색사이트 또는 다른 사이트에 노출할 수 있으며, 2차적저작물과 편집저작물 등으로 작성하여 "몰”이 제휴한 타사에 검색노출, 판촉, 홍보 및 기타 용도로 복제, 전송, 또는 전시할 수 있습니다.
...
②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
            ...
            <div class="text_person">
                ...
                <div class="text_check">
                    <input type="checkbox" id="" name="" class="texc_chk">개인정보취급방침의 내용에 동의합니다.</input>
                </div>
            </div>      
            <textarea name="" id="text2" cols="1000" rows="20" readonly>
■ 수집하는 개인정보 항목
회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
ο 수집항목 : 이름 , 회사명 , 사업자등록번호, 직위, 로그인ID, 비밀번호, 비밀번호확인 질문/답변, 유선전화, 휴대전화번호, 이메일, 지역, 추천인ID, 서비스이용기록, 접속로그, 접속IP정보, 결제기록
...
회사는 개인정보 수집 및 이용목적이 달성된 후에는 예외 없이 해당 정보를 지체 없이 파기합니다.
            ...
            <div class="join_bottom">
                <li class="join_btn"><a href="./join2.jsp">회원가입</a></li>
                <li class="join_index"><a href="./index.jsp">메인으로</a></li>
            </div>
