		                    ...
		                    <tbody>
		                        ...
		                        <tr>
		                          ...
		                          <tr>
		                        	...
		                        	<td><input type="text" id="author" name="author" value="<%=author %>" readonly></td>
		                        </tr>
		                        <tr>
		                        	<th><label for="goods">관심상품</label></th>
		                        	<td><input type="text" id="goods" name="goods" value="<%=goods %>" readonly></td>
		                        </tr>   
		                        <tr>
		            	       ...
		            	       <tr>
		                        	...
		                        	<td><input type="text" id="area" name="area" value="<%=area %>" readonly></td>
		                        </tr>   
		                    </tbody>
		                </table>  
		                <button type="button" id="danger_btn">Delete</button>
						<input type="button" id="pw2" name="pw2" value="<%=pw %>" />
